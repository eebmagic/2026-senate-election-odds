...
**Decision:** Discuss/Refine — valid nuance worth addressing, but a footnote/tooltip addition is a scope/design call rather than a clear-cut fix (space is tight next to "51 to control" on the bar itself).
